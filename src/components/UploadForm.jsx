    ...
    <div className="upload-form-page">
      ...
      {isInfoVisible && (
        <div className="info">
          ...
          <div className="info__title">Para seleccionar una comida y para subir el archivo, seleccione una categoría</div>
          <div className="info__close" onClick={() => setIsInfoVisible(false)}>
            <svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 0 20 20" width="20">
              <path d="M15.8333 5.34166l-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#fff" />
            </svg>
          </div>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="upload-form">
        <div
          className={`form-group ${isDropdownOpen ? 'open' : ''}`}
          ...
          <div className="dropdown-container">
            <select
              ...
              onChange={(e) => {
                ...
                setIsDropdownOpen(false); // Cerrar el dropdown después de seleccionar una opción
              }}
