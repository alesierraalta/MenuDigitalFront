...
const UploadForm = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (comidaRef.current && !comidaRef.current.contains(event.target)) {
        setIsComidaOpen(false);
      }
    };
  ...
  return (
    <div className="upload-form-page">
      ...
      <div
        className={`form-group ${isCategoriaOpen ? 'open' : ''}`}
      ...
      <div
        className={`form-group ${isComidaOpen ? 'open' : ''}`}
        onClick={handleToggleComida}
        ref={comidaRef}
      >
      ...
      {isInfoVisible && (
        <div className="info">
          ...
          <div className="info__title">
            Para seleccionar una comida seleccione una categoría y para subir el archivo.
          </div>
